...
Perlakuan:
- **CORE** = dijelaskan dengan analogi Kuka di Versi Sederhana.
...
|---|---|---|---|
| 1 | Prinsip inti: request/respons, client-server, stateless, TCP | CORE | Kuka kirim surat ke loket, terima tanda terima. Loket tidak mengingat siapa pun. Jalur pos = TCP. |
