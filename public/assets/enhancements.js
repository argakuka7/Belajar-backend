(function () {
  ...
  function getActiveLessonInfo() {
    ...
    if (isChapter && h1Title && h1Title !== 'Masterclass Note' && h1Title !== 'Belajar Prinsip-Prinsip Backend.') {
  ...
  function getLessonDoc(slug) {
    ...
    if (activeLesson.isChapter) {
      ...
      starter = '# Belajar Prinsip-Prinsip Backend — Master Study Notes\n\n## Curriculum Notes & Architecture Plan\n- \n\n';
    }
    ...
    if (resetBtn) {
      resetBtn.addEventListener('click', function () {
        ...
        if (activeLesson.isChapter) {
          ...
          starter = '# Belajar Prinsip-Prinsip Backend — Masterclass Study Notes\n\n## Overview\n\n';
        }
        if (textarea) {
